...
for file in RoutineEditor.qml PanelScrollBar.qml ActionCard.qml ChoicePicker.qml ShortcutRecorder.qml PlainTextButton.qml KeyCap.qml EmptyState.qml Collapsible.qml Model.js Conditions.js; do
