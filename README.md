...
- **Faster saves:** rapid enable/disable edits are batched, and edits that leave generated shortcuts unchanged avoid an unnecessary Hyprland reload when the existing integration is verified.
